// Indian States and major districts mapping for fast dropdown selection
export const INDIAN_STATES = [
  {
    state: "Andhra Pradesh",
    districts: ["Anantapur", "Chittoor", "East Godavari", "Guntur", "Krishna", "Kurnool", "Prakasam", "Srikakulam", "Visakhapatnam", "Vizianagaram", "West Godavari", "YSR Kadapa", "Tirupati"]
  },
  {
    state: "Arunachal Pradesh",
    districts: ["Tawang", "West Kameng", "East Kameng", "Papum Pare", "Kurung Kumey", "Kra Daadi", "Lower Subansiri", "Upper Subansiri", "West Siang", "East Siang", "Siang", "Upper Siang", "Changlang", "Tirap", "Longding"]
  },
  {
    state: "Assam",
    districts: ["Baksa", "Barpeta", "Biswanath", "Bongaigaon", "Cachar", "Charaideo", "Chirang", "Darrang", "Dhemaji", "Dhubri", "Dibrugarh", "Goalpara", "Golaghat", "Hailakandi", "Hojai", "Jorhat", "Kamrup", "Kamrup Metropolitan", "Karbi Anglong", "Karimganj", "Kokrajhar", "Lakhimpur", "Majuli", "Morigaon", "Nagaon", "Nalbari", "Sivasagar", "Sonitpur", "Tinsukia", "Udalguri"]
  },
  {
    state: "Bihar",
  ...
  },
  {
    ...
    districts: ["Bilaspur", "Chamba", "Hamirpur", "Kangra", "Kinnaour", "Kullu", "Lahaul and Spiti", "Mandi", "Shimla", "Sirmaur", "Solan", "Una"]
  },
  {
    state: "Jammu & Kashmir",
...
export const AVATAR_OPTIONS = [
  { id: "farmer", label: "किसान (Farmer)", icon: "🌾", bg: "#10b981", url: "https://images.unsplash.com/photo-1544717305-2782549b5136?w=150&auto=format&fit=crop&q=80" },
  { id: "officer", label: "अधिकारी (Officer)", icon: "👔", bg: "#1e3c72", url: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80" },
  { id: "youth", label: "युवा / छात्र (Student)", icon: "🎓", bg: "#6366f1", url: "https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=150&auto=format&fit=crop&q=80" },
  { id: "female_leader", label: "नागरिक (Citizen)", icon: "🇮🇳", bg: "#f59e0b", url: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150&auto=format&fit=crop&q=80" },
  { id: "tech_pro", label: "इंजीनियर (Engineer)", icon: "💻", bg: "#06b6d4", url: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80" }
];
